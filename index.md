...
- 2025.7-2026.5 （乐信）负责内容生产系统的开发与维护，并支持日活百万级游戏C端分发系统的开发与维护
...
- **技术栈:** Java、Spring、Spring Boot、MySQL、Redis、MongoDB、消息队列、Python、Agent、LLM、RAG
- **后端能力:** 掌握JDK集合框架、多线程编程（线程池、锁机制）、熟悉高并发场景下的性能优化与系统设计
- **AI能力:** 了解并使用最新AI工具、熟悉部分原理运用在实际生产中
...
- 数据库迁移重构。Mongo从自建集群升级至Mongo Atlas
- 搭建CMS知识库RAG系统
